        ...
        <div className={`pp-card pp-akvo-card${p.akvo.available ? '' : ' is-preview'}`}>
          <div className="pp-card-content-wrap">
            ...
            <div className="pp-akvo-safety-note">
              {/* info-circle: understated but clear that this is a safety note */}
              ...
              <span>AKVO PLC validates every preset request — presets are PLC-mediated, never direct motion.</span>
            </div>
          </div>
