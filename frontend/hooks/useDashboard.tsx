...
export const DashboardProvider = ({ children }: { children?: ReactNode }) => {
  ...
  const devices = useMemo(() => {
    ...
    serviceDevices.forEach(d => {
      if (!robotMemberIds.has(d.id) && !petMemberIds.has(d.id) && !flairMemberIds.has(d.id) && !generatorRehlkoMemberIds.has(d.id)) uniqueDeviceMap.set(d.id, d);
    });
  ...
  }, [serviceDevices, allVirtualDevices, robotComposites, robotMemberIds, petComposites, petMemberIds, flairComposites, flairMemberIds, generatorRehlkoComposites, generatorRehlkoMemberIds]);
